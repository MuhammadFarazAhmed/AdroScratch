...
object CLibController {
    ...
    external fun getAuSKey(buildVariant: String = BuildConfig.FLAVOR): String //this one
    external fun getAuSaltKey(buildVariant: String = BuildConfig.FLAVOR): String//this one
...
//    external fun getApiToken(key: String): String
    ...
    external fun getSRKey(buildVariant: String = BuildConfig.FLAVOR): String
    external fun getJApiToken(buildVariant: String = BuildConfig.FLAVOR): String
    ...
    external fun getRecentSearchBaseUrlOnline(buildVariant: String = BuildConfig.FLAVOR): String
